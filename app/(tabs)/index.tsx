...
export default function HomeScreen() {
  ...
  const removeImage = () => {
    setCurrentNote({ ...currentNote, image: undefined });
  };
        ...
        <View style={styles.modalContainer}>
          <View style={[styles.modal, { backgroundColor: currentNote.color }]}>
            <ScrollView keyboardShouldPersistTaps="handled" >
              ...
              {currentNote.image && (
                <View style={styles.imageContainer}>
                  <TouchableOpacity onPress={() => setFullScreenImage(currentNote.image)}>
                    <Image
            ...
            <Modal
              ...
              transparent={true}
              onRequestClose={() => setFullScreenImage(undefined)}
            >
              <TouchableWithoutFeedback onPress={() => setFullScreenImage(undefined)}>
